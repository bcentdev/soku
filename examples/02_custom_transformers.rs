...
use soku::utils::{BuiltInTransformers, CustomTransformer, Result};
use std::sync::Arc;
...
async fn main() -> Result<()> {
    ...
    let add_build_info = CustomTransformer::function("add-build-info", |code| {
    ...
    let _test_transformer = BuiltInTransformers::test_only(soku::utils::TransformerType::Regex {
